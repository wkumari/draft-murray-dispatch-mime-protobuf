...
Proto2 was the first public version of the Protobuf schema language, and Proto3 and Edition 2023 came later, with the last of these being current at the time of writing. Future editions of the IDL are expected.
